...
हम स्वास्थ्य सेवाओं को किफायती, प्रभावी और नागरिक-केंद्रित बनाने के लिए प्रतिबद्ध हैं।""",
        ...
        "telemedicine_support": "टेलीमेडिसिन सपोर्ट",
        ...
        "pharmacy_locator": "फार्मेसी लोकेटर",
        "laboratory_reports": "प्रयोगशाला रिपोर्ट",
...
சுகாதாரத்தை மலிவானதாகவும், திறமையானதாகவும், குடிமக்கள் மையமாகவும் ஆக்குவதே எங்கள் உறுதிமொழியாகும்.""",
        ...
        "telemedicine_support": "தொலைமருத்துவ ஆதரவு",
        ...
        "pharmacy_locator": "மருந்தகம் கண்டுபிடிப்பு",
        "laboratory_reports": "ஆய்வக அறிக்கைகள்",
...
def show_home_page():
    ...
    features_data = {
        "English": [
            ...
            ("Emergency Alerts", "Instant notifications about urgent medical needs like accidents.", "emergency_alerts"),
            ...
            ("Telemedicine Support", "Video consultation with doctors from anywhere in India.", "telemedicine_support"),
            ("Pharmacy Locator", "Find nearby pharmacies with medicine availability updates.", "pharmacy_locator"),
            ("Ambulance Tracking", "Real-time ambulance availability and GPS tracking.", "ambulance_tracking"),
            ("Laboratory Reports", "Download lab test results securely online.", "laboratory_reports"),
        ...
        "हिन्दी": [
            ...
            ("आपातकालीन अलर्ट", "दुर्घटनाओं या आपदाओं जैसी तत्काल आवश्यकताओं के लिए सूचनाएँ।", "emergency_alerts"),
            ...
            ("टेलीमेडिसिन सपोर्ट", "भारत में कहीं से भी डॉक्टरों के साथ वीडियो परामर्श।", "telemedicine_support"),
            ("फार्मेसी लोकेटर", "दवाओं की उपलब्धता के साथ नजदीकी फार्मेसी खोजें।", "pharmacy_locator"),
            ("एम्बुलेंस ट्रैकिंग", "एम्बुलेंस की उपलब्धता और जीपीएस ट्रैकिंग।", "ambulance_tracking"),
            ("प्रयोगशाला रिपोर्ट", "लैब परीक्षण परिणाम सुरक्षित रूप से डाउनलोड करें।", "laboratory_reports"),
        ...
        "தமிழ்": [
            ...
            ("அவசர எச்சரிக்கைகள்", "விபத்துகள் அல்லது பேரழிவுகள் தொடர்பான உடனடி அறிவிப்புகள்.", "emergency_alerts"),
            ...
            ("தொலைமருத்துவ ஆதரவு", "எங்கிருந்தும் வீடியோ ஆலோசனை பெறுங்கள்.", "telemedicine_support"),
            ("மருந்தகம் கண்டுபிடிப்பு", "மருந்துகள் உள்ள மருந்தகங்களைத் தேடுங்கள்.", "pharmacy_locator"),
            ("ஆம்புலன்ஸ் கண்காணிப்பு", "உடனடி ஆம்புலன்ஸ் கிடைக்கும் நிலை மற்றும் GPS.", "ambulance_tracking"),
            ("ஆய்வக அறிக்கைகள்", "லேப் பரிசோதனை முடிவுகளை பதிவிறக்கவும்.", "laboratory_reports"),
...
elif st.session_state.current_page == "emergency_alerts":
    placeholder_page()
...
elif st.session_state.current_page == "telemedicine_support":
    telemedicine_support.show_page()
...
elif st.session_state.current_page == "pharmacy_locator":
    placeholder_page()
elif st.session_state.current_page == "laboratory_reports":
    placeholder_page()
